...
var hero = {
  ...
  alive: true,
  open_door: function() {
    console.log("The open_door function was entered");
...
// 	},
// 	fight: function() {
//		var monster.strength = Math.floor(Math.random() * ((15-1)+1) + 1),
//         if (partner == true){
//           var strength = hero.strength + partner.strength;
//         }
